...
export class StudentService {
  ...
  getEventsByStudent(id: string): Observable<any> {
    ...
    return this.http.get(this.api + `eventsByStudent/${id}`, { responseType: 'json'})//stringify de chuyen doi tu object sang json
  }


  confirmEvent(studentId: any,eventId: any, status: any): Observable<any> {
    
    return this.http.put(this.api + 'confirmEvent', {studentId: studentId, eventId: eventId, status: status}, { responseType: 'json'})//stringify de chuyen doi tu object sang json
  }
  ...
  getAStudent(Phone:string=''){    
    ...
    return this.http.post(this.api + 'getAStudent', userInfo, {responseType: 'json'})//stringify de chuyen doi tu object sang json
  }
